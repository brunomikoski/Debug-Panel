...
namespace BrunoMikoski.DebugTools.Layout
{
    public sealed class DebuggableDropdownFieldGUI : DebuggableFieldGUIBase
    {
        ...
        public new void Initialize(object targetObject, FieldInfo fieldInfo, DebuggableFieldAttribute debuggableFieldAttribute)
        {
            ...
            else
            {
                    ...
                    typeof(ScriptableObjectCollectionItem).IsAssignableFrom(fieldInfo.FieldType))
                {
                    ...
                    {
                        allAvailableScriptableObjectsItems.AddRange(CollectionsRegistry.Instance.GetAllCollectionItemsOfType(fieldInfo.FieldType));
                    }
